                                                            ...
                                                            <div class="j-input">
                                                                <select name="master_id" id="master_id" required>
                                                                    ...
                                                                    @foreach($masterList as $key => $val)
                                                                        <option value="{{ $val->refral_code }}"> {{ $val->name }}-({{ $val->refral_code }})</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="j-row">
                                                        ...
                                                        <div class="j-span4 j-unit">
                                                            <div class="j-input">
                                                                ...
                                                                <input type="text" placeholder="Phone" id="phone"
                                                                    name="phone" autocomplete="new-phone"
                                                                    class="numericOnly" maxlength="10">
                                                        ...
                                                        {{--  <div class="j-span4 j-unit">
                                                            <div class="j-input">
                                                                ...
                                                                <inpu type="text"
                                                                    value="{{ Auth::user()->refral_code }}" readonly
                                                                    placeholder="Refral code" id="ref_code">
                                                                    <span class="j-tooltip j-tooltip-right-top">Your
                                                                        contact
                                                                        phone number</span>
