    ...
    <div class="card">
        <div class="card-header">
            <div class="col-12 row">
                ...
                <div class="col-md-2">
                        <a href="{{ route('memberBySuperAdminForm') }}" class="btn btn-sm" ><span class="label label-danger">+ Add Member</a>
                    ...
                    <tbody class="text-left">
                        @forelse($memberList as $key => $val)
                            <tr id="removerow{{ $val->id }}">
                                ...
                                <td>
                                    <a href="{{ route('editMemberBySuperadmin', ['id' => $val->id]) }}" class="text-warning"
    ...
    $(document).on('click', '.block_unblock', function(e) {
        ...
        swal({
            ...
            if (confirm) {
                $.ajax({
                    type: "GET",
                    url: '{{ route('blockMemberBySuperadmin') }}',
                    data: {
                        master_id: master_id,
    ...
    $(document).on('click', '.deleteMember', function(e) {
        ...
        swal({
            ...
            if (confirm) {
                $.ajax({
                    type: "GET",
                    url: '{{ route('deleteMemberBySuperadmin') }}',
                    data: {
                        member_id: member_id,
                    },
                    success: function(data) {
