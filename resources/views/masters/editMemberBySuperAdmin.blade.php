                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">    
                                            <div id="profile_imagediv">
                                                ...
                                                <img src="{{ asset('uploads/profilePic') }}/{{ $member->profile_pic }}" alt="profile_image" id="profile_image"> 
                                                @else
                                                        ...
                                                        <div class="j-span4 j-unit">
                                                            <div class="j-input">
                                                                ...
                                                                <input type="text" placeholder="Phone" id="phone"
                                                                    name="phone" value="{{ $member->Phone_number }}">
                                                    ...
                                                    <div class="j-unit">
                                                        <div class="j-input">
                                                            ...
                                                            <input type="text" id="address"
                                                                placeholder="Address" name="address" value="{{ $member->address }}">
                                                        </div>
                                                    </div>
                                                    <!-- end address -->
                                                    <div class="divider gap-bottom-25"></div>
